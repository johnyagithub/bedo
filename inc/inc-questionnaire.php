<div id="questionnaire" style="display: none;">
  <h3 class="mb-4 text-center h-head">แบบสอบถามความพึงพอใจ</h3>
  <form action="#">
    <table class="table table-striped my-xl-5">
      <thead>
        <tr>
    ...
    <div class="row justify-content-center">
      <div class="col-6 col-sm-4 col-lg-3">
        <button class="btn btn-primary w-100 btn-sm" type="submit">ส่งความคิดเห็น</button>
      </div>
      <div class="col-6 col-sm-4 col-lg-3">
        <button class="btn btn-outline-primary w-100 btn-sm" type="button" data-fancybox-close>ไม่ส่งความคิดเห็น</button>
      </div>
    </div>
  </form>
</div>