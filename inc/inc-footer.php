  ...
  <div class="container py-5">
    <div class="row">
      <div class="col-xl-4 col-md-6 py-2 px-xl-4 order-2 order-mmd-1 order-xl-0">
        ...
        <ul>
          <li>
            <span class="material-symbols-outlined rounded-circle bg-white text-primary align-middle">call</span>
            <a href="tel:+6621417800">(66) 2141 7800</a>
          </li>
          <li>
            <span class="material-symbols-outlined rounded-circle bg-white text-primary align-middle">fax</span>
            (66) 2143 9202
          </li>
          <li>
