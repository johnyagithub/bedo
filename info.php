      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 d-xl-flex align-items-baseline flex-wrap">
            ...
            <h4 class="mb-3">Infographic (150)</h4>
          </div>
          <div class="col-md-5">
            ...
            <div class="card-body">
              <a href="info-detail.php">
                ...
                <div class="box-text">
                  ...
                  <h5 class="h-head text-line2">เรื่องน่ารู้ของ Vanilla</h5>
                </div>
              </a>
            </div>
          </div>
            ...
            <div class="card-body">
              <a href="info-detail.php">
                ...
                <div class="box-text">
                  ...
                  <h5 class="h-head text-line2">“เมี่ยงคำ” สมุนไพร ใน 1 คำ</h5>
                </div>
              </a>
            </div>
          </div>
            ...
            <div class="card-body">
              <a href="info-detail.php">
                ...
                <div class="box-text">
                  ...
                  <h5 class="h-head text-line2">มันสาคูกับต้นสาคู... คือ พืชต่าง...</h5>
                </div>
              </a>
            </div>
          </div>
